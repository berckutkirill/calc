<div class="tabs_block js_tabs_block">
  <div class="dp-options dp-options_100">
      <p class="dp-options__title">Внутреннее открывание</p>
      <div class="dp-options__wrap">
        <div class="dp-options__main">
          <div class="dp-options__item">
            ...
            <p class="dp-options__item-desc text">Менеджер в салоне поможет определить оптимальную сторону&nbsp;открывания. Рассчитает стоимость опции.</p>
          </div>
        </div>
